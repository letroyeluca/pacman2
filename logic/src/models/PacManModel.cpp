...
PacManModel::PacManModel(double x, double y, double width, double height)
    : EntityModel(x, y, width, height), m_direction(Direction::STOP),
      m_nextDirection(Direction::STOP), m_speed(0.35f) {
...
std::pair<double, double> PacManModel::getPositionAt(float dt,
                                                     Direction dir) const {
