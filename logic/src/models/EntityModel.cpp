...
bool EntityModel::collidesWithBox(double otherX, double otherY, double otherW,
                                  double otherH) const {
...
bool EntityModel::collidesWith(const EntityModel &other) const {
  return collidesWithBox(other.getX(), other.getY(),
                         other.getWidth() * other.getHitboxScale(),
                         other.getHeight() * other.getHitboxScale());
}
} // namespace logic
