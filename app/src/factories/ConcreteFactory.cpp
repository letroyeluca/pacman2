...
std::unique_ptr<logic::PacManModel> ConcreteFactory::createPacMan(double x, double y, double width, double height) {
...
std::unique_ptr<logic::CoinModel> ConcreteFactory::createCoin(double x, double y, double width, double height) {
...
std::unique_ptr<logic::WallModel> ConcreteFactory::createWall(double x, double y, double width, double height) {
...
std::unique_ptr<ScoreView> ConcreteFactory::createScoreView(double x, double y) {
    auto model = std::make_unique<logic::Score>();
    auto view = std::make_unique<ScoreView>(*model, x, y);
    m_views.push_back(std::move(view));
}
 */