...
void PacManView::onNotify(const logic::Subject &subject, logic::Event event) {
    switch (event) {
        case logic::Event::PacManUP:    m_animFrames = m_animUpFrames; break;
        case logic::Event::PacManDOWN:  m_animFrames = m_animDownFrames; break;
        case logic::Event::PacManLEFT:  m_animFrames = m_animLeftFrames; break;
        case logic::Event::PacManRIGHT: m_animFrames = m_animRightFrames; break;
        default: break;
    }
